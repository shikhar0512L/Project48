...
function preload() {
  ...
  boatSpritedata = loadJSON("assboat.json");
  boatSpritesheet = loadImage("assboat.png");
  brokenBoatSpritedata = loadJSON("assbroken_boat.json");
  brokenBoatSpritesheet = loadImage("assbroken_boat.png");
  waterSplashSpritedata = loadJSON("water_splash.json");
  waterSplashSpritesheet = loadImage("watewater_splash.png");
}
